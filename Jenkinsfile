  ...
  stages {
    stage('update main page'){
      ...
      steps {
        ...
        docker build -t rudclthe/testimg:{{TAG}} cicd/main/ &&
    ...
    stage('update blog page'){
      ...
      steps {
        sh '''
        sudo ansible kvm1 -m shell -a 'docker build -t rudclthe/testimg:{{TAG}} cicd/blog/ &&
        docker push rudclthe/testimg:{{TAG}} &&
    ...
    stage('update shop page'){
      ...
      steps {
        sh '''
        sudo ansible kvm1 -m shell -a 'docker build -t rudclthe/testimg:{{TAG}} cicd/shop/ &&
        docker push rudclthe/testimg:{{TAG}} &&
