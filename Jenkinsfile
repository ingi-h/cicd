  ...
  stages {
    stage('update main page'){
      ...
      steps {
        ...
        kubectl set image deployment deploy-main ctn-main=rudclthe/testimg:${TAG1} -n company1' --become
        '''
      }
    }
    ...
    stage('update blog page'){
      ...
      steps {
        ...
        kubectl set image deployment deploy-blog ctn-blog=rudclthe/testimg:${TAG2} -n company1' --become
        '''
      }
    }
    ...
    stage('update shop page'){
      ...
      steps {
        ...
        kubectl set image deployment deploy-shop ctn-shop=rudclthe/testimg:${TAG3} -n company1' --become
        '''
      }
    }
